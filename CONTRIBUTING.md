...
> 🤖 **使用 AI 辅助起草？** 请阅读 [`governance/ai-participation-guide.md`](governance/ai-participation-guide.md)：AI 不署名、使用须披露、事实须核验、门禁不变。
...
4. 提交 PR，标题注明章节号与认领人（如 `[扩写] §03 能力模型（认领人：XXX）`），描述中写 `Closes #Issue编号` 关联认领 Issue；**用了 AI 起草的，另加一行 AI 使用说明**（模板见 `governance/ai-participation-guide.md` §2）；由评审复核、主编终审。
